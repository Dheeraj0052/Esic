...
public class Date extends LogActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseArtist2 = FirebaseDatabase.getInstance().getReference("MEDICINE");
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                ...
                ArtistList adapter = new ArtistList(Date.this, artistList);
                listViewArtists.setAdapter(adapter);
                Toast.makeText(Date.this, "Date Not AVAILABLE", Toast.LENGTH_SHORT).show();
            } else {
                Artist artist = new Artist(s, "MEDICINE", search);
                databaseArtist2.child(id2).setValue(artist);
                Toast.makeText(Date.this, "APPOINTMENT BOOKED", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                ...
                if(date.equals(date2)||date.after(date2)) {
                    Toast.makeText(Date.this, "INVALID DATE", Toast.LENGTH_SHORT).show();
                }
                else{

                    query = FirebaseDatabase.getInstance().getReference("MEDICINE")
                            .orderByChild("artistId").equalTo(s);
                    query.addListenerForSingleValueEvent(valueEventListener);
                }
            } else {
                Toast.makeText(Date.this, "IP NOT FOUND", Toast.LENGTH_SHORT).show();
