...
public class DatePaediatric extends LogActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseArtist2 = FirebaseDatabase.getInstance().getReference("PAEDIATRIC");
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                ...
                ArtistList adapter = new ArtistList(DatePaediatric.this, artistList);
                listViewArtists.setAdapter(adapter);
                Toast.makeText(DatePaediatric.this, "Date Not AVAILABLE", Toast.LENGTH_SHORT).show();
            } else {
                Artist artist = new Artist(s, "PAEDIATRIC", search);
                databaseArtist2.child(id2).setValue(artist);
                Toast.makeText(DatePaediatric.this, "APPOINTMENT BOOKED", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                ...
                if(date.equals(date2)||date.after(date2)) {
                    Toast.makeText(DatePaediatric.this, "INVALID DATE", Toast.LENGTH_SHORT).show();
                }
                else{

                    query = FirebaseDatabase.getInstance().getReference("PAEDIATRIC")
                            .orderByChild("artistId").equalTo(s);
                    query.addListenerForSingleValueEvent(valueEventListener);
                }
            } else {
                Toast.makeText(DatePaediatric.this, "IP NOT FOUND", Toast.LENGTH_SHORT).show();
