...
public class DateSkin extends LogActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseArtist2 = FirebaseDatabase.getInstance().getReference("SKIN");
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                ...
                ArtistList adapter = new ArtistList(DateSkin.this, artistList);
                listViewArtists.setAdapter(adapter);
                Toast.makeText(DateSkin.this, "Date Not AVAILABLE", Toast.LENGTH_SHORT).show();
            } else {
                Artist artist = new Artist(s, "SKIN", search);
                databaseArtist2.child(id2).setValue(artist);
                Toast.makeText(DateSkin.this, "APPOINTMENT BOOKED", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                ...
                if(date.equals(date2)||date.after(date2)) {
                    Toast.makeText(DateSkin.this, "INVALID DATE", Toast.LENGTH_SHORT).show();
                }
                else{

                    query = FirebaseDatabase.getInstance().getReference("SKIN")
                            .orderByChild("artistId").equalTo(s);
                    query.addListenerForSingleValueEvent(valueEventListener);
                }
            } else {
                Toast.makeText(DateSkin.this, "IP NOT FOUND", Toast.LENGTH_SHORT).show();
